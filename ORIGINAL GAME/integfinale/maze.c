...
printf("%d",e->reponse);
    ...
    e->timer[0] =IMG_Load("maze/timer/0.gif");
    e->timer[1] =IMG_Load("maze/timer/1.gif");
    e->timer[2] =IMG_Load("maze/timer/2.gif");
    e->timer[3] =IMG_Load("maze/timer/3.gif");
    e->timer[4] =IMG_Load("maze/timer/4.gif");
    e->timer[5] =IMG_Load("maze/timer/5.gif");
    e->timer[6] =IMG_Load("maze/timer/6.gif");
    e->timer[7] =IMG_Load("maze/timer/7.gif");
    e->timer[8] =IMG_Load("maze/timer/8.gif");
    e->timer[9] =IMG_Load("maze/timer/9.gif");
...
// couleur noir
    ...
    A->font = TTF_OpenFont( "maze/police.ttf", 20 );
}
