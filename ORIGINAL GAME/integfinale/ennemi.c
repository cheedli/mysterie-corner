...
void initEnnemi(Ennemi *e)
{
    ...
    */
    ...
    e->en.a[0]=IMG_Load("chedli/ennemi/a/as.png");    // going right and left
    e->en.a[1] =IMG_Load("chedli/ennemi/a/ashitt.png");//attack
    e->en.a[2] =IMG_Load("chedli/ennemi/a/asdead.png");//dead
    ...
    e->en.l[0] =IMG_Load("chedli/ennemi/bl/bl.png");//runing to the player

    e->en.posl[0].h=e->en.l[0]->h;
    e->en.posl[0].w=e->en.l[0]->w/8;

    e->en.l[1]=IMG_Load("chedli/ennemi/bl/hit.png");//attacking
    ...
    e->en.c[0] =IMG_Load("chedli/ennemi/bc/walk.png");//coming to the player

    e->en.posc[0].h=e->en.c[0]->h;
    e->en.posc[0].w=e->en.c[0]->w/8;

    e->en.c[1] =IMG_Load("chedli/ennemi/bc/a.png");//attacking

    e->en.posc[1].h=e->en.c[1]->h/2;
    e->en.posc[1].w=e->en.c[1]->w/17;

    e->en.c[2] =IMG_Load("chedli/ennemi/bc/dead.png");//dead
