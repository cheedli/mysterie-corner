...
void initEnnemi(Ennemi *e)
{
    ...
    */
    ...
    e->en.a[0]=e->en.a[1]=IMG_Load("chedli/ennemi/a/as.png");    // going right and left
    e->en.a[2] =IMG_Load("chedli/ennemi/a/ashitt.png");//attack
    e->en.a[3] =IMG_Load("chedli/ennemi/a/asdead.png");//dead
    ...
    e->en.l[0] =e->en.l[1]=IMG_Load("chedli/ennemi/bl/bl.png");//runing to the player
    ...
    e->en.l[2]=IMG_Load("chedli/ennemi/bl/hit.png");//attacking
    ...
    e->en.c[0]=e->en.c[1] =IMG_Load("chedli/ennemi/bc/walk.png");//coming to the player
    ...
    e->en.c[2] =IMG_Load("chedli/ennemi/bc/a.png");//attacking

    e->en.posc[2].h=e->en.c[2]->h/2;
    e->en.posc[2].w=e->en.c[2]->w/17;

    e->en.c[3] =IMG_Load("chedli/ennemi/bc/dead.png");//dead
...
void updateEnnemi (Ennemi* E, SDL_Rect posHero )
{
    if(E->etat!=3)
    {
     if((400>E->pos[E->level].x-posHero.x))
            E->etat=1;
