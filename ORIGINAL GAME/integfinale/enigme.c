...
winorlose[0].img=IMG_Load("ons/w.png");
winorlose[1].img=IMG_Load("ons/l.png");
...
for(i=0;i<3;i++)
    ...
    boutoun[i].img=IMG_Load("ons/b.png");
...

{
    ...
    police = TTF_OpenFont("ons/f.otf", 30);
...
horloge[0] =IMG_Load("ons/horloge/1horloge.gif");
horloge[1] =IMG_Load("ons/horloge/2horloge.gif");
horloge[2] =IMG_Load("ons/horloge/3horloge.gif");
horloge[3] =IMG_Load("ons/horloge/4horloge.gif");
horloge[4] =IMG_Load("ons/horloge/5horloge.gif");
horloge[5] =IMG_Load("ons/horloge/6horloge.gif");
horloge[6] =IMG_Load("ons/horloge/7horloge.gif");
horloge[7] =IMG_Load("ons/horloge/8horloge.gif");
horloge[8] =IMG_Load("ons/horloge/9horloge.gif");
horloge[9] =IMG_Load("ons/horloge/10horloge.gif");
